...
export class Step2Component implements OnInit {
  constructor(
    ...
    this.seoService.setTitlePage('Wooza - Obrigado por enviar seus dados');
    this.setMetaTag();
    this.validate_step2();
  }
  ...
  da página /enviar-dados que o trouxe aqui. Só poderá ver essa página que tiver vindo pelo onsubmit
